...
<body>
    ...
    <div class="slidecontainer">
      ...
      <input type="range" min="0" max="180" value="0" class="slider" id="A">
    </div>
    <div class="slidecontainer">
      <label for="B">Servo B</label>
      <input type="range" min="0" max="180" value="0" class="slider" id="B">
    </div>
    <div class="slidecontainer">
      <label for="C">Servo C</label>
      <input type="range" min="0" max="180" value="0" class="slider" id="C">
    </div>
    <div class="slidecontainer">
      <label for="D">Servo D</label>
      <input type="range" min="0" max="180" value="0" class="slider" id="D">
    </div>
    <div class="slidecontainer">
      <label for="a">Servo a</label>
      <input type="range" min="0" max="180" value="0" class="slider" id="a">
